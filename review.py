...
# Call Claude
body = json.dumps({"model":"claude-haiku-4-5-20251001","max_tokens":1024,"messages":[{"role":"user","content":f"Review this code diff:\n\n{diff}"}]}).encode()
req2 = urllib.request.Request("https://api.anthropic.com/v1/messages", data=body, method="POST",
...
req3 = urllib.request.Request(f"https://api.github.com/repos/{repo}/issues/{pr_num}/comments", data=body2, method="POST",
